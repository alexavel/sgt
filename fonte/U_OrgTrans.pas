...
if btnGrava.Enabled then
  ...
  Pesquisa.nmTitulo  := 'Tabela de Órgãos de Trânsito';
  ...
  Pesquisa.AddReg('ogt_nome'    ,'Descrição' ,'ogt_nome'   ,40 ,'por Descrição' );
...
begin
  ...
  // Titulos do Banner
  lbCabeca01.Caption    := 'Tabela de Órgãos de Trânsito';
