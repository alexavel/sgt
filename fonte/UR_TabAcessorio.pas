...
begin
  ...
  // Titulos do Banner
  lbCabeca01.Caption    := 'Listagem de Acessórios de Veículos';
...
cTitulo := 'LISTAGEM DE ACESSÓRIOS DE VEÍCULOS: ORDENADO POR '+U_funcao.fIIF( rbAlfa.Checked, 'DESCRIÇÃO','CÓDIGO' );
